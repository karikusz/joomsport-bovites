...
class JFormFieldTournament extends JFormField

{
...

    {
        ...
        if ($this->value) {
            ...
            $query = 'SELECT t.name as name FROM #__bl_tournament as t WHERE t.id = '.$this->value;
            ...
            $article->title = JText::_('BLBE_TOURNAMENT');
