...
class JFormFieldSeasonallteam extends JFormField

{
...

    {
        ...
        $link = 'index.php?option=com_joomsport&amp;task='.$task.'&amp;tmpl=component&amp;function=jSelectJS_'.$this->id.'&all=1';
