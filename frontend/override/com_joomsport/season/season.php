...
<div class="seasonTable">
    ...
    <br />
    <<div id="copy" class="copyright">powered by <a href="https://joomsport.com">JoomSport: Joomla sports extension</a></div><div id="copy" class="copyright">powered by <a href="https://joomsport.com">JoomSport: Joomla sports extension</a></div>
    <?php endif;?>
     <div class="jsClear"></div>
</div>
