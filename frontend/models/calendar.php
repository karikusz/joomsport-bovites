...
class JoomSportModelCalendar extends JModelItem
{
    protected $_context = 'com_joomsport.team';
    ...
    public function getObject()
    {
        ...
        if($jinput->get("jsformat") == "json"){
            ...
            $fileName = JPATH_ROOT.'/media/bearleague/json/calendar_'.$season_id.'.json';
